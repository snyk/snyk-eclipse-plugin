...
public class LsConfigurationUpdater {
	...
	Settings getCurrentSettings() {
		...
		return new Settings(activateSnykOpenSource, activateSnykCode, activateSnykIac, insecure, endpoint,
				...
				manageBinariesAutomatically, cliPath, token, integrationName, integrationVersion, trustedFolders,
	...
	static class Settings {
		...
		public Settings(String activateSnykOpenSource, String activateSnykCode, String activateSnykIac, String insecure,
				...
				String token, String integrationName, String integrationVersion, String[] trustedFolders,
